...
class CountriesStates {
	...
	static public $sec_canadian_provinces = array(
		'A0' => 'Alberta, Canada',
	...
	static public $sec_country_codes = array(
		'B2' => 'Afghanistan',
		'Y6' => 'Aland Islands',
		'B3' => 'Albania',
		'B4' => 'Algeria',
	...
	static public $iso_country_codes = array(
		'AD' => 'Andorra',
	...
	static public function full_location_from_sec_code( $sec_code ){
		
		if ( isset(self::$states[$sec_code]) )
			return self::$states[$sec_code] . ', US';	
		
		elseif ( isset(self::$sec_canadian_provinces[$sec_code]) ){
			return self::$sec_canadian_provinces[$sec_code];
		}
		
		return self::country_name_from_sec_code($sec_code);		
	}
	
	static public function country_name_from_sec_code( $sec_code ){
		$country = 'Unknown';
		...
		elseif ( isset(self::$sec_country_codes[$sec_code]) ){
			$country = self::$sec_country_codes[$sec_code];
		}
		
		return $country;
	}
	
	static public function iso_from_sec_code( $sec_code ){
		$iso = 'Unknown';
		...
		// Its another country
		elseif ( isset(self::$sec_country_codes[$sec_code]) ){
			$sec_name = self::$sec_country_codes[ $sec_code ];
			$iso = array_search( $sec_name, self::$iso_country_codes );
		}
